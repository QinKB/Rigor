...
class GuardTests(unittest.TestCase):
    ...
    def test_design_write_denied_until_evidence_and_freeze(self):
        ...
        upstream=json.loads(self.ctl("evidence","add","--kind","upstream-code","--source","github","--locator","r@c:f","--summary","impl","--observed","mcp__github__search_code").stdout)
        ...
        self.ctl("verification","plan","--entrypoint","entry","--protocol","real path","--integration-observed","python integration.py","--acceptance-observed","python acceptance.py","--artifact-policy","fresh if stateful")
    ...
    def test_agent_contract_and_subagent_result(self):
        ...
        self.ctl("verification","plan","--entrypoint","entry","--protocol","real path","--integration-observed","python integration.py","--acceptance-observed","python acceptance.py","--artifact-policy","none")
    ...
    def test_mechanical_task_cannot_write_research_sensitive_path(self):
        ...
        self.ctl("verification","plan","--entrypoint","entry","--protocol","real path","--integration-observed","python real.py","--acceptance-observed","python real.py","--artifact-policy","none")
